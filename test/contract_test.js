...
function getContractAbi(contractName,cb){
     var file = './contracts/TicketLedger.sol';
...
describe('Contract1', function() {
     before("Initialize everything", function(done) {
          web3.eth.getAccounts(function(err, as) {
               ...
               // TODO: если на Node несколько аккаунтов, то они могут перепутаться
               creator = '0xb9Af8aA42c97f5A1F73C6e1a683c4Bf6353B83E7';

               //creator = accounts[0];

               // 1 - abi 1
               var contractName = ':TicketLedger';
               getContractAbi(contractName,function(err,jsonAbi){
                    ledgerAbi = jsonAbi;
